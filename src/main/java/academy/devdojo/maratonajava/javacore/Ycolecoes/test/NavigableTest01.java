...
public class NavigableTest01 {
    public static void main(String[] args) {
        ...
        for (Manga manga : mangas) {                          //for (Manga manga : mangas.descendingSet()) { <- ordem inversa
        ...
        System.out.println(mangas.pollLast() );             //retorna e remove o elemento da lista -> first primeiro | last ultimo
        System.out.println(mangas.size());
